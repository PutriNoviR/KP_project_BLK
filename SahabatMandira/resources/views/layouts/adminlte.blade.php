    ...
    <div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown" style="float: right; padding: 13px">
                <a href="#" onclick="return false;" role="button" data-toggle="dropdown" id="dropdownMenu1"
            ...
            <li class="nav-item">
                <div class="dropdown">
                    @if (auth()->user()->role->nama_role == 'superadmin')
                        <button class="btn dropdown-toggle btn-dark text-uppercase" type="button"
                            data-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-user-circle"></i> &nbsp; {{ Auth::user()->username }}
                        </button>
                    @elseif (auth()->user()->role->nama_role == 'peserta')
                        <button class="btn dropdown-toggle btn-white text-uppercase" type="button"
                            data-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-user-circle"></i> &nbsp; {{ Auth::user()->username }}
                        </button>
                    @else
                        <button class="btn dropdown-toggle btn-primary text-uppercase" type="button"
                            data-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-user-circle"></i> &nbsp; {{ Auth::user()->username }}
                        </button>
                    @endif
                    <div class="dropdown-menu w-100">
                        ...
                        @can('peserta-permission')
                            <a class="dropdown-item" href="{{ route('lamaran.lamaranku') }}" type="button">Kegiatan
                                Ku</a>
                        @endcan
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                <img src="{{ asset('landingpage/assets/img/logos/sahabatmandira.png') }}" alt="SahabatMandira Logo"
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @can('adminperusahaan-permission')
                            @if (Auth::user()->perusahaans_id_admin != null)
                                @if (Auth::user()->perusahaan->verified_by == null)
                                @else
                                <li class="nav-item has-treeview">
                                ...
                                <li class="nav-item has-treeview">
                                    <a href="{{ route('pencaker.index') }}"
                                        class="nav-link {{ Request::is('menu/pencaker') ? 'active' : '' }}">
                        ...
                        @can('adminblk-permission')
                            @if (auth()->user()->role->nama_role == 'superadmin')
                                <li class="nav-item">
                                    <a href="{{ route('User.daftar') }}"
                                        class="nav-link {{ Request::is('daftar') ? 'active' : '' }}">
                            ...
                            @endif
                            <li class="nav-item has-treeview">
                                <a href="{{ route('sesiPelatihan.index') }}"
                        ...
                        @if (Auth::user()->role->nama_role == 'peserta')
                            <li class="nav-item has-treeview">
                                <a href="{{ route('listKerja.index') }}"
                                    class="nav-link {{ Request::is('bursa/listKerja') ? 'active' : '' }}">
                        ...
                        @can('adminblk-permission')
                            <li class="nav-item has-treeview {{ Request::is('paketProgram') ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('paketProgram.index') }}"
                                            class="nav-link {{ Request::is('paketProgram') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('sesiPelatihan.daftarPelatihan') }}"
                                    class="nav-link {{ Request::is('daftarPelatihan') ? 'active' : '' }}">
                        ...
                        @can('super.admin-permission')
                            <li class="nav-item has-treeview {{ Request::is('menu/*') ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('subkejuruan.index') }}"
                                            class="nav-link {{ Request::routeIs('subkejuruan.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item has-treeview ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('perusahaan.getDokumen') }}" class="nav-link">
                                            <i class="fas fa-school nav-icon"></i>
                                            <p>Validasi Perusahaan</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('perusahaan.semuadata') }}" class="nav-link">
                                            <i class="fas fa-school nav-icon"></i>
                                            <p>Data Perusahaan</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="perusahaan/log" class="nav-link">
                                            <i class="fas fa-code nav-icon"></i>
                                            <p>Log</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/bidang-kerja" class="nav-link">
