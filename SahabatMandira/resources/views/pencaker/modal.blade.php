...
<div class="modal-content">
    ...
    <div class="modal-body">
        @php
            ...
            $pelamar = nilaiKualifikasi($user->pendidikan_terakhir);
            $lowonganPendidikan = nilaiKualifikasi ($lamaran->lowongan->pendidikan_terakhir);

            if($pelamar >= $lowonganPendidikan){
                $kualifikasiPendidikan = 'Sesuai Kriteria';
            }
            else{
                $kualifikasiPendidikan = 'Tidak Sesuai Kriteria';
            }
        ...
        <div class="row ml-5">
            <div class="col-md-12">
                ...
                <p><span class="info-label">Pendidikan</span> : {{ $user->pendidikan_terakhir }}
                    <strong>({{  $kualifikasiPendidikan }})</strong>
                </p>
