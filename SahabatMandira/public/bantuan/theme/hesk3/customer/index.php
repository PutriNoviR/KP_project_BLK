...
<div class="content">
        <div class="block__head">
            ...
            <h3 class="h-3 ml-1">Knowledgebase</h3>
                    ...
                    <!-- list kb -->
        <div class="topics" style="padding: 25px 30px;">
            <div class="topics__block">
                <h5 class="topics__title">
                    ...
                    <span>
                        <a class="title-link" href="https://sahabatmandira.id/bantuan/theme/hesk3/customer/articles/article.php">
                            Daftar Pelatihan Rekomendasi                                    
                        </a>
                    </span>
                </h5>
