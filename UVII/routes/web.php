...
Route::get('menu/tes', 'PesertaController@menuTesHome')->name('peserta.tes');
Route::get('menu/tes/uji-tahap-awal', 'PesertaController@menuTesUjiTahapAwal')->name('peserta.uji.tahap.awal');
