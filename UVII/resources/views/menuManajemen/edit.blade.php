          ...
          @method("PUT")
            <div class="modal-body">
              ...
              <div class="form-group row">
                  ...
                  <label for="menu_manajemen" class="col-md-4">Nama:</label>
                  <div class="col-md-8">
              ...
              <div class='form-group row'>
                <!-- <div class="row col-md-12"> -->
                    <label for="menu_manajemen" class="col-md-4">Deskripsi :</label>
                    <div class="col-md-8">
              ...
              <div class='form-group row'>
                  ...
                  <!-- <div class="row col-md-12">     -->
                      ...
                      <div class="col-md-4">
                          <label>
                            <input type="radio" class='form-control' name='status' value="Aktif" {{ $manajemenEdit->status == 'Aktif' ? 'checked':'' }}>
                            Aktif
                          </label>
                          <label>
                            <input type="radio" class='form-control' name='status' value="Tidak Aktif" {{ $manajemenEdit->status == 'Tidak Aktif' ? 'checked':'' }}>
                              Tidak Aktif
                          </label>
                      </div>   
              ...
              <div class='form-group row'>
                <!-- <div class="row col-md-12"> -->
                    <label for="menu_manajemen" class="col-md-4">URL :</label>
                    <div class="col-md-8">
